...
longDescription = "5-axis post for MIKRON with a Heidenhain control.";
...
function onSection() {
  ...
  if (insertToolCall) {
    ...
    // commented to prevent breakage control of each tool
    //    if (!isFirstSection()) {
